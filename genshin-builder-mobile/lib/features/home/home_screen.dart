                ...
                children: [
                  ...
                  FilledButton.icon(
                    onPressed:
                        () => AppShellScope.of(
                          context,
                        ).switchMainTab(MainTab.characters.index),
                  ...
                  OutlinedButton.icon(
                    onPressed:
                        () => AppShellScope.of(
                          context,
                        ).switchMainTab(MainTab.daily.index),
...
class _BookmarkSection extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('ブックマーク素材', style: Theme.of(context).textTheme.titleLarge),
        const SizedBox(height: 8),
        bookmarksAsync.when(
          data: (bookmarks) {
        ...
        if (bookmarksAsync.valueOrNull?.isNotEmpty == true)
          TextButton(
            onPressed:
                () => AppShellScope.of(
                  context,
                ).switchMainTab(MainTab.materials.index),
                    ...
                    children: [
                      if (report.isEvaluable)
                        Row(
                          children: [
                            Text(
                              '${report.totalScore!.toStringAsFixed(0)}\u70b9',
                              style: theme.textTheme.headlineSmall,
                            ),
                            const SizedBox(width: 8),
                            Text(
                              '\u8a55\u4fa1\u53ef\u80fd: ${report.evaluatedCategoryCount}\u30ab\u30c6\u30b4\u30ea',
                            ),
                          ],
                        )
                      else
                        Text(
                          '\u73fe\u5728\u306e\u30c7\u30fc\u30bf\u3067\u306f\u80b2\u6210\u72b6\u6cc1\u3092\u8a55\u4fa1\u3067\u304d\u307e\u305b\u3093\u3002',
                          style: theme.textTheme.bodySmall,
                        ),
                      const SizedBox(height: 4),
                      if (report.strengths.isNotEmpty)
                        Text(
                          '\u5f37\u307f: ${report.strengths.first}',
                          style: theme.textTheme.labelMedium,
                        ),
                      if (report.improvementCandidates.isNotEmpty)
                        Text(
                          '\u6539\u5584\u5019\u88dc: ${report.improvementCandidates.first}',
                          style: theme.textTheme.labelMedium,
                        ),
                      const SizedBox(height: 4),
                      Text(
                        '\u30c7\u30fc\u30bf\u30ab\u30d0\u30ec\u30c3\u30b8: ${report.dataCoverage}',
