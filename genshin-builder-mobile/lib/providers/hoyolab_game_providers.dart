...
final hoyolabOwnedFetchResultProvider =
    FutureProvider<OwnedCharactersFetchResult>((ref) async {
      ...
      final discoveryStore = await ref.watch(
...
final sortedCharacterEntriesProvider = FutureProvider<List<CharacterListEntry>>(
  (ref) async {
...
final hoyolabCharacterBuildProvider =
    FutureProvider.family<HoyolabCharacterBuild?, String>((
      ref,
      characterId,
    ) async {
      final flags = await ref.watch(featureFlagsProvider.future);
