...
Map<String, Object?> structuredRecommendationJson() => {
  ...
  'gameVersion': '5.8',
  'context': {'role': 'dps', 'weaponPreference': '旧文字列は無視されるはず'},
  'weapons': <Object?>[
    {
      'weaponId': 'w1',
      'displayName': '護摩の杖',
    ...
    {'weaponId': 'w2', 'rank': 2, 'reason': '無課金向け', 'conditions': <Object?>[]},
  ],
  'artifactRecommendations': <Object?>[
    {
      ...
      'reason': '爆発特化の定番4セット',
      'conditions': <Object?>[],
      'source': {'videoId': 'vid1', 'channelName': 'Sample Channel'},
    },
    {
      'sets': <Object?>[
  ...
  'targets': <Object?>[
    {'stat': 'er', 'min': 180, 'max': 220, 'unit': 'percent'},
  ],
  'caveats': <Object?>[],
  'sources': <Object?>[
    {
